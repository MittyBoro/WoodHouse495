      ...
      <div class="price-table">
        <table>
          <tbody>
            ...
            <tr>
              <td>Пропиливание проёма окна, двери</td>
              <td>250р м.п.</td>
            </tr>
            <tr>
              <td>Окосячка *в закладной брусок*</td>
              <td>от 2500р</td>
            </tr>
            <tr>
              <td>Окосячка *в шип*</td>
              <td>от 3500р</td>
            </tr>
            <tr>
              <td>Окосячка *в колоду*</td>
              <td>от 3500р</td>
            </tr>
            <tr>
              <td>Окосячка с чистовым откосом</td>
              <td>от 4500р</td>
            </tr>
            <tr>
              <td>Обработка проема антисептиком</td>
              <td>70 м.п.</td>
            </tr>
            <tr>
              <td>Установка плавающих коробок</td>
              <td>от 2500р</td>
            </tr>
            <tr>
              <td>Установка дверей</td>
              <td>
                <p><small>Деревянная дверь</small> — 3000р</p>
                <p><small>Железная дверь</small> — 2500р
              </td>
            </tr>
            <tr>
              <td>Врезка замка, ручки</td>
              <td>от 1000р</td>
            </tr>
            <tr>
            ...
            <tr>
              <td>Покраска оконных и дверных блоков</td>
              <td>от 700р</td>
            </tr>
            <tr>
              <td>Утепление окон, дверей</td>
              <td>100р м.п.</td>
            </tr>
            <tr>
