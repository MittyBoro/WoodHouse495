...
@section('content')
  ...
  <div class="home-box roofing-home-box outbuildings-home-box">
    <div class="container grid-with-form grid grid-md-12">
      ...
      <div class="left-col">
        <div class="h1"><b>Строительство пристроек</b> в Москве и области
        </div>
        <div class="sub-h">
      ...
      <div class="right-col">
        <form class="form form-wrapper">
          <input type="hidden" name="form_name"
            value="Строительство пристроек: Заказ мастера">
          <div class="title-row">
  ...
  <div class="cost-box roofing-cost-box outbuildings-cost-box">
    ...
    <div class="container">
      ...
      <form class="form-calc cost-form form-grid">
        <input type="hidden" name="Рассчёт" value="Строительство пристроек">
