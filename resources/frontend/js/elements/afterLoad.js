  ...
  document.querySelectorAll('.prevent').forEach(el => {
	...
	document.querySelectorAll('.form-input .options-value').forEach(el => {
		...
		el.addEventListener('click', (e) => {
			...
			parent.querySelectorAll('.options-value').forEach(val => val.classList.remove('active'))
			el.classList.add('active');
		});
	});
	document.querySelectorAll('.form-input .options-value:first-child').forEach(el => el.click());
